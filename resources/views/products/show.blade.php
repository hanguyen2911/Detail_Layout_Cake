...
<head>
	...
	<link rel="stylesheet" href="{{ asset('sourse/assets/dest/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{ asset('sourse/assets/dest/vendors/colorbox/example3/colorbox.css')}}">
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">1*<span>{{$product->unit_price}}</span></span>
										</div>
									</div>
								</div>
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="{{ asset('product_type.html'}}">Sản phẩm 1</a></li>
								<li><a href="{{ asset('product_type.html'}}">Sản phẩm 2</a></li>
					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="single-item-options">
								...
								<a class="add-to-cart" href="#"><i class="{{ asset('fa fa-shopping-cart'}}"></i></a>
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
							...
							<div class="col-sm-4">
								<div class="single-item">
									<div class="single-item-header">
										<a href="product.html"><img src="{{ asset('assets/dest/images/products/4.jpg'}}" alt=""></a>
									</div>
									<div class="single-item-body">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<div class="widget">
						...
						<div>
							<ul>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Web Design</a></li>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Web development</a></li>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Marketing</a></li>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Tips</a></li>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Resources</a></li>
								<li><a href="{{ asset('blog_fullwidth_3col.html'}}"><i class="fa fa-chevron-right"></i> Illustrations</a></li>
							</ul>
						</div>
					</div>
				</div>
